...
The project aims to standardise and document methods, so that comparisons can be as valid and clear as possible. Therefore, quite some effort needs to be put into organisation of data and processing, and each individual study needs to be carefully inserted into the project framework.
